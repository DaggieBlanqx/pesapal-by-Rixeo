...
function pesapal_pay_payment_form($atts){
	...
	$output .=	'</fieldset>	 	 
			...
			<button name="pespal_pay" id="pespal_pay_btn" class="pespal_pay_btn">'.$button_name.'</button>';
	
	$output .= '<script type="text/javascript">';
	$output .= 'jQuery(document).ready(function(){';
	$output .= 'jQuery("#pespal_pay_btn").click(function(){';
	$output .= 'jQuery("#pespal_pay_btn").val("Processing......");';
	$output .= 'jQuery(\'#pesapal_transaction_directive\').html(\'<p style= "font-size:30px;font-weight:bold;color:blue;">processing ...</p>\');';
	$output .= '/';
	$output .= 'jQuery.ajax({';
	$output .= 'type: "POST",';
